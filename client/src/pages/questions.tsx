    ...
    return (
        <>
            ...
            <main className="pt-36 pb-24 md:pb-12 bg-main min-h-screen">
                ...
                {createPortal(
                    <ImgModal modal={imgModal} showModal={showImgModal} />,
                    document.getElementById("img-modal") as HTMLElement
                )}
            </main>
        </>
    );
    ...
    return (
        <div className="py-4 px-8 flex items-center">
            ...
            <div className="ml-auto mr-2">
                <Link
                    className="p-4 hover:bg-gray-50 rounded-full"
                    title="preview"
                    to="preview"
                    target="_blank"
                    rel="noreferrer"
            ...
            <button
                title="save form"
                onClick={() => {}}
                className="hidden sm:block bg-purple-700 text-white capitalize py-2 px-4"
            >
                save form
            </button>
        </div>
...
function CustomNavLink({
    ...
    return (
        <NavLink
            className={`mx-4 ${
                disabled ? "pointer-events-none text-gray-400" : "pb-2"
            } font-semibold`}
            to={path}
        >
            {navLabel}
