                    ...
                    <div className="mb-16" key={cat.id}>
                        <div className="flex items-center mb-4">
                            ...
                            {qId > 0 && (
                                <Icon
                                    id={qId}
                                    handleClick={() => removeCategorizeQues(qId)}
                                    icon="&#215;"
                                    color="red"
                                />
                            )}
                        ...
                        <div className="mt-4 mb-4">
                            <div className="flex items-center mb-4">
                                ...
                                <Icon handleClick={() => addCategory(qId)} icon="&#43;" />
                            </div>
                            ...
                            {cat.categories?.map((category, catId) => {
                                return (
                                    <div className="flex items-center mb-4" key={`${qId}-${catId}`}>
                                        ...
                                        {catId > 0 && (
                                            <Icon
                                                handleClick={() => removeCategory(qId, catId)}
                                                icon="&#215;"
                                            />
                                        )}
                                    </div>
                            ...
                            <div className="flex items-center mt-4 mb-4">
                                ...
                                <Icon handleClick={() => addItem(qId)} icon="&#43;" />
                                ...
                                return (
                                    ...
                                    >
                                        <Input
                                            ...
                                            val={item.name}
                                            onChange={(e) =>
                                                handleInputChange(e, qId, "items", itemId, "name")
                                            }
                                        />
                                        {itemId > 0 && (
                                            <Icon
                                                handleClick={() => removeItem(qId, itemId)}
                                                icon="&#215;"
                                            />
                                        )}
                                        <Select
