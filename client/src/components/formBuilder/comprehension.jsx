                ...
                return (
                    <div key={passage.id} className="my-8">
                        <div className="flex items-start">
                            ...
                            ></textarea>
                            <Icon handleClick={addComprehensionQuestions} icon="&#43;" />
                            {index > 0 && (
                                <Icon
                                    id={index}
                                    handleClick={() => removeComprehensionQuestion(index)}
                                    icon="&#215;"
                                    color="red"
                                />
                            )}
                                    ...
                                    <div key={`${passage.id}-${id}`}>
                                        <div className="flex items-center mb-5 mt-6">
                                            <Input
                                                ...
                                                val={item.text}
                                                onChange={(e) =>
                                                    handleInputChange(e, index, "ques", id, "text")
                                                }
                                            />
                                            <Icon handleClick={() => addMcq(index)} icon="&#43;" />
                                            {id > 0 && (
                                                <Icon
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <Input
                                                ...
                                                val={item.a}
                                                onChange={(e) =>
                                                    handleInputChange(e, index, "ques", id, "a")
                                                }
                                            />
                                            <Input
                                                name="text"
                                                ...
                                                val={item.b}
                                                onChange={(e) =>
                                                    handleInputChange(e, index, "ques", id, "b")
                                                }
                                            />
                                            <Input
                                                name="text"
                                                ...
                                                val={item.c}
                                                onChange={(e) =>
                                                    handleInputChange(e, index, "ques", id, "c")
                                                }
                                            />
                                            <Input
                                                name="text"
                                                ...
                                                val={item.d}
                                                onChange={(e) =>
                                                    handleInputChange(e, index, "ques", id, "d")
                                                }
                                            />
                                        </div>
                                    </div>
